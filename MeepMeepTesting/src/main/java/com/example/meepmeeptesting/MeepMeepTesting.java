...
public class MeepMeepTesting {
    public static void main(String args[]) {
        MeepMeep mm = new MeepMeep(1000)
         ...
         Pose2d blue_2_shipping_hub_pos     = new Pose2d(-10.625,  45.75, Math.toRadians(-90));
         ...
         Pose2d blue_warehouse_pos        = new Pose2d( 38.75, 64.75, Math.toRadians(0 ));
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(mm)
                ...
                .setConstraints(100, 100, Math.toRadians(180), Math.toRadians(180), 11.8)
...
//                                .splineToLinearHeading(blue_warehouse_pos, Math.toRadians(0), SampleMecanumDrive.getVelocityConstraint(15, 35, 11.8), SampleMecanumDrive.getAccelerationConstraint(40))
//                                .splineToLinearHeading(blue_warehouse_enter_pos, Math.toRadians(0))
//                                .splineToLinearHeading(blue_2_shipping_hub_pos, Math.toRadians(-90))
//                                .splineToLinearHeading(blue_warehouse_enter_pos, Math.toRadians(0))
//                                .splineToLinearHeading(blue_warehouse_pos, Math.toRadians(0), SampleMecanumDrive.getVelocityConstraint(15, 35, 11.8), SampleMecanumDrive.getAccelerationConstraint(40))
...
//                                .splineToLinearHeading(blue_warehouse_pos, Math.toRadians(0), SampleMecanumDrive.getVelocityConstraint(15, 35, 11.8), SampleMecanumDrive.getAccelerationConstraint(40))
                                ...
                                //go to warehouse entrance
                                .lineToLinearHeading(blue_warehouse_pos, SampleMecanumDrive.getVelocityConstraint(15, 35, 11.8), SampleMecanumDrive.getAccelerationConstraint(40))
                                .lineToLinearHeading(blue_warehouse_enter_pos)
                                .lineToLinearHeading(blue_2_shipping_hub_pos)
                                .waitSeconds(2)
                                .lineToLinearHeading(blue_warehouse_enter_pos)
