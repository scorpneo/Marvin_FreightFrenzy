...
//        marvyn.The_Claw.setPosition(Claw_Close_Pos);
        ...
        marvyn.mecanumDrive.setPoseEstimate(marvyn.red_1_pose_estimate);
    ...
    void buildTrajectories()
    {
        ...
        mrvRed1 = marvyn.mecanumDrive.trajectorySequenceBuilder(marvyn.red_1_pose_estimate)
                //drive to hub
                .lineToLinearHeading(marvyn.red1_shipping_hub_pos)
                .addTemporalMarker(() -> {
...
//                })
                ...
                .lineToLinearHeading(marvyn.red_duck_wheel_pos)
                //do duck
                .addTemporalMarker(() -> {
                ...
                //enter warehouse
                .lineToLinearHeading(marvyn.red_storage_pos)
