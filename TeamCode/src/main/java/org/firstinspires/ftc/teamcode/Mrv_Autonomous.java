...
//    public static double starting_pos_x = 12;
    ...
    public static MyPose2d test_pos;
    public static MyPose2d red_1_pose_estimate       = new MyPose2d(-36, -62, 90);
    public static MyPose2d red_2_pose_estimate       = new MyPose2d( 12, -62, 90);
    public static MyPose2d blue_1_pose_estimate      = new MyPose2d(-36, -62, 90);
    public static MyPose2d blue_2_pose_estimate      = new MyPose2d( 12, -62, 90);
    public static MyPose2d red_shipping_hub_pos      = new MyPose2d(-12, -48, 40);
    public static MyPose2d blue_shipping_hub_pos     = new MyPose2d(-12,  48, -40);
    public static MyPose2d red_duck_wheel_pos        = new MyPose2d(  0, -48, 130);
    public static MyPose2d blue_duck_wheel_pos       = new MyPose2d(-55, -55, 90);
    public static MyPose2d red_warehouse_enter_pos   = new MyPose2d( 24, -64, 0);
    public static MyPose2d blue_warehouse_enter_pos  = new MyPose2d( 24, 64, 0);
    public static MyPose2d red_warehouse_pos         = new MyPose2d( 40, -64, 0);
    public static MyPose2d blue_warehouse_pos        = new MyPose2d( 40, 64, 0 );
    public static MyPose2d red_park_pos              = new MyPose2d( 64, -36, 90);
    public static MyPose2d blue_park_pos             = new MyPose2d( 64, 36, -90);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        mrvWarehouseLevel = 2; //MrvGetWarehouseLevel(MrvAllianceField.BLUE);
        mrvTelemetry.addData("Warehouse Level", mrvWarehouseLevel);
        mrvTelemetry.update();

        buildTrajectories();

        marvyn.mecanumDrive.setPoseEstimate(blue_2_pose_estimate.getPose2d());
    ...
    {
        // Red 1 Trajectory
//        mrvRed1 = marvyn.mecanumDrive.trajectorySequenceBuilder(red_1_pose_estimate.getPose2d())
//                //drive to hub
//                .lineToLinearHeading(red_shipping_hub_pos.getPose2d())
//                //TODO: set exact end pose for duck spline
//                .lineToLinearHeading(red_duck_wheel_pos.getPose2d())
//                //do duck
//                .waitSeconds(3)
//                //go to warehouse entrance
//                .lineToLinearHeading(red_warehouse_enter_pos.getPose2d())
//                //enter warehouse
//                .lineToLinearHeading(red_warehouse_pos.getPose2d())
//                //park
//                .lineToLinearHeading(red_park_pos.getPose2d())
//
//                .build()
//        ;
//
//        mrvRed2 = marvyn.mecanumDrive.trajectorySequenceBuilder(red_2_pose_estimate.getPose2d())
//                //drive to hub
//                .lineToLinearHeading(red_shipping_hub_pos.getPose2d())
//                //TODO: set exact end pose for duck spline
//                .lineToLinearHeading(red_duck_wheel_pos.getPose2d())
...
//        ;
//
//        mrvBlue1 = marvyn.mecanumDrive.trajectorySequenceBuilder(blue_1_pose_estimate.getPose2d())
//                //drive to hub
//                .lineToLinearHeading(blue_shipping_hub_pos.getPose2d())
//                //TODO: set exact end pose for duck spline
//                .lineToLinearHeading(blue_duck_wheel_pos.getPose2d())
//                //do duck
//                .waitSeconds(3)
//                //go to warehouse entrance
//                .lineToLinearHeading(blue_warehouse_enter_pos.getPose2d())
//                //enter warehouse
//                .lineToLinearHeading(blue_warehouse_pos.getPose2d())
//                //park
//                .lineToLinearHeading(blue_park_pos.getPose2d())
//
//                .build()
//        ;
//
        mrvBlue2 = marvyn.mecanumDrive.trajectorySequenceBuilder(blue_2_pose_estimate.getPose2d())
                //drive to hub
                .lineToLinearHeading(blue_shipping_hub_pos.getPose2d())
